<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inspection.aspx.cs" Inherits="_Default" %>
...
<body style="width:100%; height:100%; margin:0;padding:0;position:fixed;">
    ...
    <div style="width: 50%; height: 60%;">
        <div style="width: 100%; height: 10%;color:#000;font-size: 15px;">2、探伤检测信息</div>
        <div style="width: 100%; height: 90%;">
            <table class="table">
                <tr style="width: 100%; font-size: 7px;">
                    <td class="td3">探伤结果：</td>
                    <td id="td7" class="td4"></td>
                </tr>
                <tr style="width: 100%; font-size: 7px;">
                    <td class="td5" colspan="2">异常情况描述：</td>
                </tr>
            </table>
            <table class="table">
                <tr style="width: 100%; font-size: 7px;">
                    <td class="td6">编号</td>
                    <td class="td6">级别</td>
                    <td class="td7">缺陷角度</td>
                    <td class="td7">最大深度</td>
                    <td class="td8">报警探头</td>
                    <td class="td9">缺陷描述</td>
                </tr>
                <tr style="width: 100%; font-size: 7px;">
                    <td id="td8" class="td6_1"></td>
                    <td id="td9" class="td6_1"></td>
                    <td id="td10" class="td7_1"></td>
                    <td id="td11" class="td7_1"></td>
                    <td id="td12" class="td8_1"></td>
                    <td id="td13" class="td9_1"></td>
                </tr>
            </table>
            <table class="table" style="height: 80%;">
                <tr style="width: 100%; height: 10%; font-size: 7px;">
                    <td class="td10">异常部位示意图</td>
                    <td class="td10" colspan="2">处理意见</td>
                </tr>
                <tr style="width: 100%; font-size: 7px;">
                    <td class="td11" rowspan="2"><div id="echart1" style="height:100%; float:left; "></div></td>
                    <td class="td12">检测系统提示</td>
                    <td id="td14" class="td13"></td>
                 </tr>
                <tr style="width: 100%; font-size: 7px;">
                    <td class="td14">探伤工程师处理意见</td>
                    <td id="td15" class="td15"></td>
                 </tr>
            </table>
        </div>
    </div>
    <div style="width: 50%; height: 10%;margin-top:1%;">
        <div style="width: 60%;height:100%;float:left;margin-left:1%;">探伤工程师（盖章）<input type="text" style="width:50%;border:none;border-bottom:1px solid #000;" disabled="disabled" /></div>
        <div style="width: 30%;height:100%;float:right;margin-right:1%;">审核<input type="text" style="width:60%;border:none;border-bottom:1px solid #000;" disabled="disabled" /></div>
    </div>
    ...
    <script>
        ...
        function int() {
            ...
            if (data.length == 0) {
                ...
                $("#td7").html("无缺陷");
                $("#td8").html(1);
                $("#td9").html(data[0].ALARM_LEVEL);
                $("#td10").html(data[0].PROBE_ANGLE);
                $("#td11").html(data[0].DEFECT_DEPTH + "mm");
                $("#td12").html(data[0].PROBE_TYPE);
                $("#td13").html("无描述");
                $("#td14").html("检测系统提示处理意见");
                $("#td15").html("探伤工程师处理意见处理意见");
